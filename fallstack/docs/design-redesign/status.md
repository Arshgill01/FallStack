...
## Pitch video revision

- 2026-07-16: User review rejected the generated bell-led trailer score as juvenile and found the one-clip-per-copy-beat edit visually repetitive. The selected Cutaway Reliquary grammar remains frozen.
- Replaced eight 5–8 second gameplay holds with seventeen 2.3–4.5 second clips from the same real production-build fall-to-summit capture. Each concept now has two board states; the theme beat has a dedicated three-shot Lower Ruins/Bell Shaft/Moon Roof montage.
