...
Audit point: local `master` at `e56c97c` on 2026-07-27. The user-owned
`docs/fixplan.md` remains outside this work.
...
| Original music           | Choice open                                           | Three original, reproducible previews in [`music-directions`](evidence/music-directions/)                                                                                                                                                                                    | User selects A/B/C; integrate, capture at least ten minutes, measure, and listen                                          |
